...
const preview_link = [
    { title: 'VueJs Version', img: icon1, url: 'https://adminmart.com/product/matdash-vuejs-admin-dashboard/?ref=56#product-demo-section' },
    { title: 'Angular Preview', img: icon2, url: 'https://adminmart.com/product/matdash-material-angular-dashboard-template/?ref=56#product-demo-section' },
    { title: 'Nextjs Preview', img: icon3, url: 'https://adminmart.com/product/matdash-next-js-admin-dashboard-template/?ref=56#product-demo-section' },
    {
    ...
    },
    {
        ...
        img: icon5,
        url: 'https://adminmart.com/product/matdash-vuetify-nuxt-js-admin-template/#product-demo-section'
    },
    { title: 'Bootstrap Preview', img: icon6, url: 'https://adminmart.com/product/matdash-bootstrap-5-admin-dashboard-template/?ref=56#product-demo-section' }
];
</script>
<template>
        ...
        <div class="d-flex flex-lg-row flex-column gap-3 justify-space-between align-center">
            ...
            <div class="d-flex flex-md-row flex-column align-center ga-4">
                ...
                <div class="d-flex flex-md-row flex-wrap justify-md-end justify-center ga-3">
                    ...
                    <v-btn
                        class=" text-surface text-h6 font-weight-medium" rounded="sm" color="primary"
